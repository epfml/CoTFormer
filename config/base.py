...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument('--eval_length_factor', default=None, nargs='*', type=float)
    parser.add_argument('--training_length_factor', default=None, nargs='*', type=float)
    parser.add_argument('--disable_ln_mid', action='store_true') # if true then model is compiled 
    # Universal Transformer
    parser.add_argument('--halt_threshold', default=0.999, type=float)
    parser.add_argument('--depth_predictor_loss_coef', default=None, type=float)
    ...
    parser.add_argument('--remove_intermediary_checkpoints_at_end', default=False, action='store_true')
    

    args = parser.parse_args(args, namespace)

    if args.depth_predictor_loss_coef is None:
        # Backward compatibility
        args.depth_predictor_loss_coef = 1.0
        args.act_penalty = 0.03
    else:
        args.act_penalty = args.depth_predictor_loss_coef
    parser.set_defaults(depth_predictor_loss_coef=1.0)
